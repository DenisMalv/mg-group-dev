...
const options = {
	...
	on: {
		slideNextTransitionStart: function () {
			...
			if (swiper.activeIndex === 0 || swiper.activeIndex === 1 || swiper.activeIndex === 2 || swiper.activeIndex === swiper.slides.length - 1 || swiper.activeIndex === swiper.slides.length - 2) {
				...
				if (swiper.activeIndex === swiper.slides.length - 2 && swiper.previousIndex === swiper.slides.length - 4) {
					multiple = 1;
				} else if (swiper.slides.length === 6 && ((swiper.activeIndex === swiper.slides.length - 2 && swiper.previousIndex === 0) || (swiper.activeIndex === swiper.slides.length - 2 && swiper.previousIndex === 1))) {
					multiple = 1;
				} else {
					return;
				}
		...
		slidePrevTransitionStart: function (e) {
			...
			if (swiper.activeIndex === swiper.slides.length - 3 || swiper.activeIndex === swiper.slides.length - 2 || swiper.activeIndex === swiper.slides.length - 1 || swiper.activeIndex === 1 || swiper.activeIndex === 0) {
				...
				if (swiper.activeIndex === 1 && swiper.previousIndex === 3) {
					multiple = 1;
				} else if (swiper.slides.length === 6 && ((swiper.activeIndex === 1 && swiper.previousIndex === swiper.slides.length - 1) || (swiper.activeIndex === 1 && swiper.previousIndex === swiper.slides.length - 2))) {
					multiple = 1;
				} else {
					return;
				}
